...
import 'package:caderno_de_campo/domain/models/usuario/usuario.dart';
...
import 'edit/edit_propriedade_screen.dart';
...
class _PropriedadeScreenState extends State<PropriedadeScreen> {
  final PropriedadeRepository _propriedadeDAO = PropriedadeRepository(PropriedadeService());
  ...
  void _refreshPropriedade() {
    setState(() {
      _propriedadeFuture = _propriedadeDAO.getByUsuario(widget.user.id!);
    });
  }
