...
import '../../../data/services/local/usuario_service.dart';
...
class _RegisterProducerScreenState extends State<RegisterProducerScreen> {
  ...
  final _authRepository = AuthRepository(UsuarioService(), ProdutorService());
  ...
  Future<void> _handleFinalizeRegistration() async {
    if (_formKey.currentState!.validate()) {
      ...
      final mecanismo = fullData['mecanismoControle'] as Map<String, dynamic>;


      final success = await _authRepository.cadastrar(
        fullData['email'] as String,
        fullData['senha'] as String,
        fullData['nomeProdutor'] as String,
        mecanismo['tipo'] as String,
        mecanismo['nome'] as String,
      );
